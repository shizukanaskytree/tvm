...
keras_resnet50 = ResNet50(include_top=True, weights='imagenet',
                          input_shape=(224, 224, 3), classes=1000)
#keras_resnet50.load_weights(weights_path)
#keras_mobilenetv2 = MobileNetV2(include_top=True, weights='imagenet',
#                                input_shape=(224, 224, 3), classes=1000)
...
#keras_out = keras_mobilenetv2.predict(data.transpose([0, 2, 3, 1]))
